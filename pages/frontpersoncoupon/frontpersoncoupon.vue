	...
	<view class="coupon">
		...
		<view class="top bg-yellow ">
			<view class="con bg-grey">
				<view class="quan bg-yellow margin-bottom-lg" v-if="TabCur==0||TabCur==1">
				...
				<view class="quan bg-yellow margin-bottom-lg" v-if="TabCur==0||TabCur==1">
					<view class="quan_l qy-bg-white">
						<view class="quan_l_01 qy-text-yellow"><span>20</span> ¥</view>
						<view class="quan_l_02 qy-text-grey">
							无门槛通用<br/>骑手随意购
						</view>
						<view class="yuan-gary"></view>
				...
				<view class="quan qy-bg-grey margin-bottom-lg" v-if="TabCur==0||TabCur==2">
					<view class="quan_l qy-bg-white">
						<view class="quan_l_01 qy-text-yellow"><span>12</span> ¥</view>
						<view class="quan_l_02 qy-text-grey">
							无门槛通用<br/>骑手随意购
			...
			<view class="quan qy-bg-grey margin-bottom-lg" v-if="TabCur==0||TabCur==2">
					<view class="quan_l qy-bg-white">
						<view class="quan_l_01 qy-text-yellow"><span>8</span> ¥</view>
						<view class="quan_l_02 qy-text-grey">
							无门槛通用<br/>骑手随意购
						</view>
						<view class="yuan-gary"></view>
